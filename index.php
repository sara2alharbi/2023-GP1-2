...
<section class="about" id="about">
    ...
    <div class="row">
        ...
        <div class="image">
            <img src="images/aboutgif.gif" alt="">
        </div>
        ...
        <div class="content">
            ...
            <a href="https://www.youtube.com/watch?v=JAMxqWVDJUE" class="btn"> شـاهـد</a>
        </div>
    </div>
</section>
...
<section class="services" id="services">
    ...
    <h1 class="heading">خدمـاتـنا</h1>

    <div class="box-container">

        <div class="box">
            <img src="images/sound.png" alt="">
            <h3>مراقبة مستوى الضوضاء</h3>
