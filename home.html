...
<body>
  ...
  <header id="header" class="d-flex flex-column justify-content-center">
    ...
    <nav id="navbar" class="navbar nav-menu">
      ...
      <ul>
        ...
        <li><a href="#about" class="nav-link scrollto"><i class="bx bx-file-blank"></i> <span>من نحن</span></a></li>
        <li><a href="#services" class="nav-link scrollto"><i class="bx bx-server"></i> <span>خدماتنا</span></a></li>
      </ul>
    </nav><!-- .nav-menu -->
  ...
  <section id="hero" class="d-flex flex-column justify-content-center">
    <div class="container" data-aos="zoom-in" data-aos-delay="100">
      <h1>إلـمـام</h1>
      <br>
      <p><span class="typed" data-typed-items="في كل زمان و مكان,راحتك هي هدفنا"></span></p>
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row">
          ...
          <div class="col-lg-8 pt-4 pt-lg-0 content">
            ...
            <br>
            <br>
            <p  dir="rtl" lang="ar">نحن فريق إلمام يقوم نظامنا على قيم الابتكار والجودة والخدمة الرائعة  
          ونحن نؤمن بأن تقديم أفضل خدمة تساعد على تحسين جودة حياة الأفراد 
             نحن نعمل على مراقبة درجة الحرارة وجودة الهواء في الغرف داخل المبنى 
            دون انتهاك خصوصية الزائر . نقدم أفضل الخدمات وأجدد التقنيات</p>
        ...
        <div class="row">
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4" data-aos="zoom-in" data-aos-delay="300">
            <div class="icon-box iconbox-teal">
              ...
              <h4>عرض الغرف المتاحة في المبنى</h4>
               <p>من خلال مستشعراتنا نستطيع توفير الجهد على مدير المبنى حيث يستطيع معرفة الغرف المتاحة في وقت معين
            </div>
          </div>
  ...
  <footer id="footer">
    <div class="container">
      ...
      <div class="copyright">
       جميع الحقوق محفوظة لإلمام ©2023
      </div>
